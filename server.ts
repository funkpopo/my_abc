...
function handleCors() {
  return new Response(null, {
    ...
    headers: {
      ...
      'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-Requested-With, api-key, x-api-key, Accept, Accept-Language, Content-Language, Copilot-Session-ID, Copilot-Trace-ID',
...
async function handleWebSocketRequest(request, targetUrl) {
  try {
    ...
    const allowedHeaders = [
      'authorization', 'user-agent', 'api-key', 'x-api-key',
